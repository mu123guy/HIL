###########################################################################
## Makefile generated for Simulink model 'px4demo_serial'. 
## 
## Makefile     : px4demo_serial.mk
## Generated on : Wed Jan 01 16:01:15 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/px4demo_serial.pre.o
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/px4demo_serial.pre.o
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/SUPPOR~1/px4/include -I$(START_DIR)/px4demo_serial_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_ = -DMODEL=px4demo_serial -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DPX4 -DFMUvx -DNULL=0 -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DDAEMON_MODE=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=px4demo_serial -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/px4/src/MW_SCI.c C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/px4/src/MW_uORB_Read.cpp $(START_DIR)/px4demo_serial_ert_rtw/px4demo_serial.cpp $(START_DIR)/px4demo_serial_ert_rtw/px4demo_serial_data.cpp C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/px4/src/MW_PX4_TaskControl.cpp C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/px4/src/nuttxinitialize.cpp

MAIN_SRC = $(START_DIR)/px4demo_serial_ert_rtw/ert_main.cpp
...
OBJS = MW_SCI.o MW_uORB_Read.cpp.o px4demo_serial.cpp.o px4demo_serial_data.cpp.o MW_PX4_TaskControl.cpp.o nuttxinitialize.cpp.o
...
%.o : $(START_DIR)/px4demo_serial_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/px4demo_serial_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.cpp.o : $(START_DIR)/px4demo_serial_ert_rtw/ert_main.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


px4demo_serial.cpp.o : $(START_DIR)/px4demo_serial_ert_rtw/px4demo_serial.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


px4demo_serial_data.cpp.o : $(START_DIR)/px4demo_serial_ert_rtw/px4demo_serial_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
