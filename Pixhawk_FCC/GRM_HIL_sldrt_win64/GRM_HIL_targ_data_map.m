  ...
  ;%***********************
    ...
    ;%
      ...
      section.nData     = 645;
      section.data(645)  = dumData; %prealloc
	  ...
	  section.data(81).dtTransOffset = 54691;
	  ...
	  section.data(2).logicalSrcIdx = 739;
	  section.data(2).dtTransOffset = 1;
	
	  ;% GRM_HIL_P.SensorROT_Y0
	  section.data(3).logicalSrcIdx = 740;
	  section.data(3).dtTransOffset = 2;
	
	  ;% GRM_HIL_P.quaternion_Y0
	  section.data(4).logicalSrcIdx = 741;
	  section.data(4).dtTransOffset = 3;
	
	  ;% GRM_HIL_P.TestSignal_Y0
	  section.data(5).logicalSrcIdx = 742;
	  section.data(5).dtTransOffset = 4;
	
	  ;% GRM_HIL_P.Constant6_Value_c
	  section.data(6).logicalSrcIdx = 743;
	  section.data(6).dtTransOffset = 5;
	  ...
	  section.data(2).logicalSrcIdx = 790;
	  section.data(2).dtTransOffset = 1;
	
	  ;% GRM_HIL_P.Constant_Value_lk
	  section.data(3).logicalSrcIdx = 791;
	  section.data(3).dtTransOffset = 2;
	
	  ;% GRM_HIL_P.Constant2_Value_l
	  section.data(4).logicalSrcIdx = 792;
	  section.data(4).dtTransOffset = 3;
	
	  ;% GRM_HIL_P.Output_InitialCondition
	  section.data(5).logicalSrcIdx = 793;
	  section.data(5).dtTransOffset = 4;
	
	  ;% GRM_HIL_P.FixPtConstant_Value
	  section.data(6).logicalSrcIdx = 794;
	  section.data(6).dtTransOffset = 5;
	  ...
	  section.data(1).logicalSrcIdx = 795;
	  section.data(1).dtTransOffset = 0;
	
	  ;% GRM_HIL_P.Constant6_Value_b
	  section.data(2).logicalSrcIdx = 796;
	  section.data(2).dtTransOffset = 1;
	
	  ;% GRM_HIL_P.Constant8_Value_ej
	  section.data(3).logicalSrcIdx = 797;
	  section.data(3).dtTransOffset = 2;
	
	  ;% GRM_HIL_P.Status_Y0
	  section.data(4).logicalSrcIdx = 798;
	  section.data(4).dtTransOffset = 3;
	
	  ;% GRM_HIL_P.packetfound_flg_Y0
	  section.data(5).logicalSrcIdx = 799;
	  section.data(5).dtTransOffset = 4;
	
	  ;% GRM_HIL_P.Constant9_Value_b
	  section.data(6).logicalSrcIdx = 800;
	  section.data(6).dtTransOffset = 5;
	
	  ;% GRM_HIL_P.Constant12_Value_e
	  section.data(7).logicalSrcIdx = 801;
	  section.data(7).dtTransOffset = 6;
	
	  ;% GRM_HIL_P.Constant_Value_gt
	  section.data(8).logicalSrcIdx = 802;
	  section.data(8).dtTransOffset = 7;
	
	  ;% GRM_HIL_P.Constant2_Value_f5
	  section.data(9).logicalSrcIdx = 803;
	  section.data(9).dtTransOffset = 8;
	
	  ;% GRM_HIL_P.Constant3_Value_k
	  section.data(10).logicalSrcIdx = 804;
	  section.data(10).dtTransOffset = 9;
	
	  ;% GRM_HIL_P.Constant1_Value_c3
	  section.data(11).logicalSrcIdx = 805;
	  section.data(11).dtTransOffset = 10;
	
	  ;% GRM_HIL_P.Constant3_Value_it
	  section.data(12).logicalSrcIdx = 806;
	  section.data(12).dtTransOffset = 11;
	  ...
	  section.data(2).logicalSrcIdx = 808;
	  section.data(2).dtTransOffset = 1;
	
	  ;% GRM_HIL_P.PixRCStatus_Y0
	  section.data(3).logicalSrcIdx = 809;
	  section.data(3).dtTransOffset = 2;
	
	  ;% GRM_HIL_P.message_pass_Y0
	  section.data(4).logicalSrcIdx = 810;
	  section.data(4).dtTransOffset = 3;
	
	  ;% GRM_HIL_P.Constant_Value_jh
	  section.data(5).logicalSrcIdx = 811;
	  section.data(5).dtTransOffset = 4;
	
	  ;% GRM_HIL_P.Constant1_Value_ec
	  section.data(6).logicalSrcIdx = 812;
	  section.data(6).dtTransOffset = 5;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  section.data(93).dtTransOffset = 134;
	
	  ;% GRM_HIL_B.Product4
	  section.data(94).logicalSrcIdx = 93;
	  section.data(94).dtTransOffset = 135;
	  ...
	  section.data(103).dtTransOffset = 175;
	  ...
	  section.data(106).dtTransOffset = 194;
	  ...
	  section.data(119).dtTransOffset = 229;
	
	  ;% GRM_HIL_B.Data_plus_p
	  section.data(120).logicalSrcIdx = 119;
	  section.data(120).dtTransOffset = 230;
	  ...
	  section.data(123).dtTransOffset = 233;
	
	  ;% GRM_HIL_B.Clock_minus_c
	  section.data(124).logicalSrcIdx = 123;
	  section.data(124).dtTransOffset = 234;
	
	  ;% GRM_HIL_B.Data_plus_pe
	  section.data(125).logicalSrcIdx = 124;
	  section.data(125).dtTransOffset = 235;
	
	  ;% GRM_HIL_B.Data_minus_jy
	  section.data(126).logicalSrcIdx = 125;
	  section.data(126).dtTransOffset = 236;
	
	  ;% GRM_HIL_B.Clock_plus_jb
	  section.data(127).logicalSrcIdx = 126;
	  section.data(127).dtTransOffset = 237;
	
	  ;% GRM_HIL_B.Clock_minus_d1
	  section.data(128).logicalSrcIdx = 127;
	  section.data(128).dtTransOffset = 238;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% GRM_HIL_DW.TAQSigLogging_InsertedFor_Serial_Recieve_from_Pixhawk_at_outport_8_PWORK.AQHandles
  ...
  targMap.checksum0 = 2598223174;
  targMap.checksum1 = 3665355216;
  targMap.checksum2 = 2059130372;
  targMap.checksum3 = 1554374079;
