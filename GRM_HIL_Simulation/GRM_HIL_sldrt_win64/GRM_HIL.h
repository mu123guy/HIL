...
typedef struct {
  void *RealTimeSynchronization_PWORK; /* '<S2>/Real-Time Synchronization' */
  int8_T Synchronize_to_realtime_SubsysRanBC;/* '<S1>/Synchronize_to_realtime' */
} DW_GRM_HIL_T;
...
struct P_GRM_HIL_T_ {
  ...
  boolean_T Constant9_Value;           /* Computed Parameter: Constant9_Value
                                        ...
                                        */
  boolean_T Constant3_Value; /* Expression: HIL_Data.Simulation_Ctrl.offline_flg
 ...
 *
 * '<Root>' : 'GRM_HIL'
 * '<S1>'   : 'GRM_HIL/Simulation_Ctrl'
 * '<S2>'   : 'GRM_HIL/Simulation_Ctrl/Synchronize_to_realtime'
 * '<S3>'   : 'GRM_HIL/Simulation_Ctrl/hearbeat_SIM'
 * '<S4>'   : 'GRM_HIL/Simulation_Ctrl/hearbeat_SIM/Counter Free-Running'
 * '<S5>'   : 'GRM_HIL/Simulation_Ctrl/hearbeat_SIM/Counter Free-Running/Increment Real World'
 * '<S6>'   : 'GRM_HIL/Simulation_Ctrl/hearbeat_SIM/Counter Free-Running/Wrap To Zero'
 */
