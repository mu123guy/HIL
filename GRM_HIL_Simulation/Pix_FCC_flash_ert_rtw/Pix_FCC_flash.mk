...
## Generated on : Thu Jan 02 20:41:13 2020
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/guy-m/Desktop/HIL/GRM_HIL_Simulation
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/SUPPOR~1/px4/include -I$(START_DIR)/Pix_FCC_flash_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/serial -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2019b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_ = -DMODEL=Pix_FCC_flash -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DEXT_MODE=1 -DINTEGER_CODE=0 -DMT=0 -DPX4 -DFMUvx -DNULL=0 -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DDAEMON_MODE=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMW_PX4_EXTMODE_BAUD_RATE=3000000 -DMW_PX4_EXTMODE_HWPORT="/dev/ttyACM0"
...
DEFINES_STANDARD = -DMODEL=Pix_FCC_flash -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SCI.o MW_PX4_PWM.cpp.o MW_uORB_Read.cpp.o Pix_FCC_flash.cpp.o Pix_FCC_flash_data.cpp.o rtGetInf.cpp.o rtGetNaN.cpp.o rt_nonfinite.cpp.o updown.o ext_work.o rtiostream_utils.o MW_PX4_TaskControl.cpp.o nuttxinitialize.cpp.o MW_PX4_rtiostream_serial.cpp.o rtiostream_interface.o ext_svr_daemon.o daemon_checksum.o
...
MW_PX4_rtiostream_serial.cpp.o : C:/ProgramData/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/px4/src/MW_PX4_rtiostream_serial.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
