...
typedef struct {
  ...
  int8_T SendWhiteNoiseBeginning_SubsysR;// '<S9>/Send WhiteNoise Beginning'
...
typedef struct {
  ...
  int8_T SendHeader_SubsysRanBC;       // '<S9>/Send Header'
...
typedef struct {
  ...
  real_T SineWave;                     // '<S43>/Sine Wave'
  real_T SineWave_j;                   // '<S9>/Sine Wave'
  ...
  int32_T b_ii;
  int32_T idx;
  uint16_T Cast[2];                    // '<S43>/Cast'
  uint8_T update[4];                   // '<S8>/update'
  uint8_T cmd[4];                      // '<S6>/DecodeCommand'
  uint8_T ReceiveData_o1[128];         // '<Root>/Receive Data'
  uint8_T pack[4];
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Acc_x_PWORK;                       // '<S43>/Acc_x'

  struct {
    void *LoggedData;
  } Heartbeat_PWORK;                   // '<S43>/Heartbeat'
  ...
  struct {
    void *LoggedData;
  } Scope_PWORK_h;                     // '<S21>/Scope'

  struct {
    void *LoggedData;
  } Scope1_PWORK_m;                    // '<S21>/Scope1'
  ...
  struct {
    void *LoggedData;
  } Messagefound_PWORK;                // '<S6>/Message found'
  ...
  int8_T EnabledSubsystem_SubsysRanBC; // '<S63>/Enabled Subsystem'
  int8_T EnabledSubsystem_SubsysRanBC_a;// '<S61>/Enabled Subsystem'
  int8_T EnabledSubsystem_SubsysRanBC_o;// '<S59>/Enabled Subsystem'
  int8_T ExecutionCycle_SubsysRanBC;   // '<Root>/ExecutionCycle'
  int8_T OUTPUT_SubsysRanBC;           // '<S2>/OUTPUT'
  int8_T SendData_SubsysRanBC;         // '<S39>/Send Data'
  int8_T ACTION_SubsysRanBC;           // '<S2>/ACTION'
  int8_T Saturate_SubsysRanBC;         // '<S28>/Saturate'
  int8_T Pass_SubsysRanBC;             // '<S28>/Pass'
  int8_T process_received_data_SubsysRan;// '<S2>/process_received_data'
  int8_T input_hold_SubsysRanBC;       // '<S21>/input_hold'
  int8_T hold_SubsysRanBC;             // '<S52>/hold'
  int8_T heartbeat_SubsysRanBC;        // '<S2>/heartbeat'
  int8_T memory_SubsysRanBC;           // '<S1>/memory'
  int8_T DecodeCommand_SubsysRanBC;    // '<S1>/DecodeCommand'
  int8_T ConfirmCommand_SubsysRanBC;   // '<S6>/ConfirmCommand'
  int8_T SendData_SubsysRanBC_b;       // '<S9>/Send Data'
  int8_T SendRCConfrimation_SubsysRanBC;// '<S9>/Send RC Confrimation'
  boolean_T DecodeCommand_MODE;        // '<S1>/DecodeCommand'
  boolean_T ConfirmCommand_MODE;       // '<S6>/ConfirmCommand'
...
struct P_Pix_FCC_flash_T_ {
  ...
  real_T SineWave_Amp_e;               // Expression: 1
                                          //  Referenced by: '<S43>/Sine Wave'

  real_T SineWave_Bias_o;              // Expression: 0
                                          //  Referenced by: '<S43>/Sine Wave'

  real_T SineWave_Freq_j;              // Expression: 1
                                          //  Referenced by: '<S43>/Sine Wave'
