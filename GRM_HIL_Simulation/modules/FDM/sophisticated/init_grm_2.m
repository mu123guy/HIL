...
function bus2 = init_grm()
    ...
    if bus2.flag_I_flat == 1
        ...
        bus2.hBE_0 = 100*eps;                 % [m] initial geoemtric height/altitude
        ...
        bus2.qGB_0 = euler_to_q([0;-pi/4;0]);
    ...
    elseif bus2.flag_sim_mode == 3
        bus2.T_sim_lnch = eps;                 %[s] start time missile in global simulation time
