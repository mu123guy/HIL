...
#ifndef RTW_HEADER_GRM_HIL_Simple_h_
#define RTW_HEADER_GRM_HIL_Simple_h_
#include <string.h>
#ifndef GRM_HIL_Simple_COMMON_INCLUDES_
# define GRM_HIL_Simple_COMMON_INCLUDES_
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* GRM_HIL_Simple_COMMON_INCLUDES_ */

#include "GRM_HIL_Simple_types.h"
...
#define GRM_HIL_Simple_rtModel         RT_MODEL_GRM_HIL_Simple_T
...
} ExtY_GRM_HIL_Simple_T;

/* Backward compatible GRT Identifiers */
#define rtB                            GRM_HIL_Simple_B
#define BlockIO                        B_GRM_HIL_Simple_T
#define rtY                            GRM_HIL_Simple_Y
#define ExternalOutputs                ExtY_GRM_HIL_Simple_T
#define rtP                            GRM_HIL_Simple_P
#define Parameters                     P_GRM_HIL_Simple_T
#define rtDWork                        GRM_HIL_Simple_DW
#define D_Work                         DW_GRM_HIL_Simple_T

/* Parameters (default storage) */
struct P_GRM_HIL_Simple_T_ {
...
struct tag_RTM_GRM_HIL_Simple_T {
  const char_T *path;
...
extern P_GRM_HIL_Simple_T GRM_HIL_Simple_P;

/* Block signals (default storage) */
extern B_GRM_HIL_Simple_T GRM_HIL_Simple_B;

/* Block states (default storage) */
extern DW_GRM_HIL_Simple_T GRM_HIL_Simple_DW;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_GRM_HIL_Simple_T GRM_HIL_Simple_Y;

/* Model entry point functions */
extern void GRM_HIL_Simple_initialize(void);
extern void GRM_HIL_Simple_output(void);
extern void GRM_HIL_Simple_update(void);
extern void GRM_HIL_Simple_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern GRM_HIL_Simple_rtModel *GRM_HIL_Simple(void);
...
extern RT_MODEL_GRM_HIL_Simple_T *const GRM_HIL_Simple_M;
 ...
 *
 * '<Root>' : 'GRM_HIL_Simple'
 * '<S1>'   : 'GRM_HIL_Simple/ByteUnpack'
 * '<S2>'   : 'GRM_HIL_Simple/ExtractMessage'
 * '<S3>'   : 'GRM_HIL_Simple/hold'
 */
#endif                                 /* RTW_HEADER_GRM_HIL_Simple_h_ */
