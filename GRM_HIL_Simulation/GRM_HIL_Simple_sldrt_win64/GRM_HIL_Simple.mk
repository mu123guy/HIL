...
MODEL                := GRM_HIL_Simple
MODULES              := GRM_HIL_Simple_data.c GRM_HIL_Simple_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := GRM_HIL_Simple.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := GRM_HIL_Simple_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/guy-m/Documents/MATLAB/HIL/GRM_HIL_Simulation;C:/Users/guy-m/Documents/MATLAB/HIL/GRM_HIL_Simulation/GRM_HIL_Simple_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
