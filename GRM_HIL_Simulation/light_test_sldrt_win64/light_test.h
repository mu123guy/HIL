...
#ifndef RTW_HEADER_light_test_h_
#define RTW_HEADER_light_test_h_
#include <string.h>
#ifndef light_test_COMMON_INCLUDES_
# define light_test_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* light_test_COMMON_INCLUDES_ */

#include "light_test_types.h"
...
#define light_test_rtModel             RT_MODEL_light_test_T
...
#define rtB                            light_test_B
#define BlockIO                        B_light_test_T
#define rtP                            light_test_P
#define Parameters                     P_light_test_T
#define rtDWork                        light_test_DW
#define D_Work                         DW_light_test_T

/* Parameters (default storage) */
struct P_light_test_T_ {
...
extern P_light_test_T light_test_P;

/* Block signals (default storage) */
extern B_light_test_T light_test_B;

/* Block states (default storage) */
extern DW_light_test_T light_test_DW;

/* Model entry point functions */
extern void light_test_initialize(void);
extern void light_test_output(void);
extern void light_test_update(void);
extern void light_test_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern light_test_rtModel *light_test(void);
...
extern RT_MODEL_light_test_T *const light_test_M;
 ...
 *
 * '<Root>' : 'light_test'
 * '<S1>'   : 'light_test/Counter Free-Running'
 * '<S2>'   : 'light_test/Radians to Degrees'
 * '<S3>'   : 'light_test/Radians to Degrees1'
 * '<S4>'   : 'light_test/Radians to Degrees2'
 * '<S5>'   : 'light_test/Ramp'
 * '<S6>'   : 'light_test/Ramp1'
 * '<S7>'   : 'light_test/Ramp2'
 * '<S8>'   : 'light_test/Counter Free-Running/Increment Real World'
 * '<S9>'   : 'light_test/Counter Free-Running/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_light_test_h_ */
