...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2019b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := light_test
MODULES              := light_test_data.c light_test_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := light_test.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2019b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := light_test_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/guy-m/Desktop/HIL_branch/GRM_HIL_Simulation;C:/Users/guy-m/Desktop/HIL_branch/GRM_HIL_Simulation/light_test_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
