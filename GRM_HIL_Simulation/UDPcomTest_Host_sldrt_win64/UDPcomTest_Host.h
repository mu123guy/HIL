...
#ifndef RTW_HEADER_UDPcomTest_Host_h_
#define RTW_HEADER_UDPcomTest_Host_h_
#include <stddef.h>
#include <string.h>
#include <math.h>
#ifndef UDPcomTest_Host_COMMON_INCLUDES_
# define UDPcomTest_Host_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* UDPcomTest_Host_COMMON_INCLUDES_ */

#include "UDPcomTest_Host_types.h"
...
#define UDPcomTest_Host_rtModel        RT_MODEL_UDPcomTest_Host_T

/* Block signals (default storage) */
typedef struct {
  real_T SignalGenerator;              /* '<Root>/Signal Generator' */
  uint16_T Cast;                       /* '<Root>/Cast' */
  uint8_T BytePacking[52];             /* '<Root>/Byte Packing ' */
  boolean_T CastToBoolean;             /* '<Root>/Cast To Boolean' */
  boolean_T CastToBoolean1;            /* '<Root>/Cast To Boolean1' */
} B_UDPcomTest_Host_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } sendingsignal_PWORK;               /* '<Root>/sending signal ...' */

  void *RealTimeSynchronization_PWORK; /* '<Root>/Real-Time Synchronization' */
  int_T UDPConfigure_IWORK[6];         /* '<Root>/UDP Configure' */
  int_T BytePacking_IWORK[18];         /* '<Root>/Byte Packing ' */
  int_T UDPSend2_IWORK[3];             /* '<Root>/UDP Send2' */
} DW_UDPcomTest_Host_T;

/* Invariant block signals (default storage) */
typedef struct {
  const real_T Width;                  /* '<Root>/Width' */
} ConstB_UDPcomTest_Host_T;

/* Backward compatible GRT Identifiers */
#define rtB                            UDPcomTest_Host_B
#define BlockIO                        B_UDPcomTest_Host_T
#define rtP                            UDPcomTest_Host_P
#define Parameters                     P_UDPcomTest_Host_T
#define rtDWork                        UDPcomTest_Host_DW
#define D_Work                         DW_UDPcomTest_Host_T
#define tConstBlockIOType              ConstB_UDPcomTest_Host_T
#define rtC                            UDPcomTest_Host_ConstB

/* Parameters (default storage) */
struct P_UDPcomTest_Host_T_ {
  ...
  real_T UDPConfigure_P12_Size[2];  /* Computed Parameter: UDPConfigure_P12_Size
                                     * Referenced by: '<Root>/UDP Configure'
                                     */
  real_T UDPConfigure_P12;             /* Expression: disable
                                        * Referenced by: '<Root>/UDP Configure'
                                        */
  ...
  real_T Zero_Value;                   /* Expression: 0
                                        ...
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 10
  ...
  real_T UDPSend2_P3_Size[2];          /* Computed Parameter: UDPSend2_P3_Size
                                        * Referenced by: '<Root>/UDP Send2'
                                        */
  real_T UDPSend2_P3[13];              /* Computed Parameter: UDPSend2_P3
                                        * Referenced by: '<Root>/UDP Send2'
                                        */
...
struct tag_RTM_UDPcomTest_Host_T {
  const char_T *path;
...
extern P_UDPcomTest_Host_T UDPcomTest_Host_P;

/* Block signals (default storage) */
extern B_UDPcomTest_Host_T UDPcomTest_Host_B;

/* Block states (default storage) */
extern DW_UDPcomTest_Host_T UDPcomTest_Host_DW;
extern const ConstB_UDPcomTest_Host_T UDPcomTest_Host_ConstB;/* constant block i/o */

/* Model entry point functions */
extern void UDPcomTest_Host_initialize(void);
extern void UDPcomTest_Host_output(void);
extern void UDPcomTest_Host_update(void);
extern void UDPcomTest_Host_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern UDPcomTest_Host_rtModel *UDPcomTest_Host(void);
...
extern RT_MODEL_UDPcomTest_Host_T *const UDPcomTest_Host_M;
 ...
 *
 * '<Root>' : 'UDPcomTest_Host'
 */
#endif                                 /* RTW_HEADER_UDPcomTest_Host_h_ */
